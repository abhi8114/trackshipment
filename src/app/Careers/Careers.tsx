    ...
    return (
        <div>
            ...
            <section id="progress-section" className="h-[300vh] relative">
                <div className="sticky top-0 h-screen flex flex-col items-center justify-start bg-gray-50">
                    <div className="mt-20 text-center max-w-2xl">
                        <h2 className="text-[40px] font-manrope font-semibold mb-28">Our Process</h2>
                    </div>
                    <ProgressBar />
                </div>
            </section>
